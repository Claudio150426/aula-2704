...
let r = parseInt(prompt("Digite o raio do círculo em centímetro(s):"));
let pi = parseFloat(3,14);

let area = document.write("A área do círculo é: "+pi*(r**2)+"cm.");
let peri = document.write("<br/>E o perímetro do cículo é: "+2*pi*r+"cm.");
